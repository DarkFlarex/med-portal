...
import { useSearchDoctorsMutation } from "../../app/api/search";
...
const MedicalFacility = () => {
  ...
  return (
    ...
    >
      <button onClick={handleSearch}>Поиск докторов</button>
      ...
      >
        ...
        {clinics.length === 0 && <Typography>Клиники не найдены</Typography>}
      </Grid>
    </Box>
  );
};
